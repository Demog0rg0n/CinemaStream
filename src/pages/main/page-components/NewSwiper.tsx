...
const NewSwiper: FC = () => {
    ...
    const {data, isLoading, error} = useGetMoviesQuery({type: "movie", sortField: "votes.imdb", sortType: -1, year: 2025, notNullFields: ["backdrop.url"]});
    ...
    return (
        ...
        >
                        ...
                        <SwiperSlide key={movie.id}>
                            <div className="new__slide">
                                <div className="new__slide__container container">
                                    <div className="new__slide__content">
            ...
            }
            {
                isLoading && 
                <SwiperSlide>
                    <div className="new__slide__container loader"></div>
                </SwiperSlide>
            }
